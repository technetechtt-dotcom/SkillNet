...
import { MOCK_INVOICES } from './InvoiceList';
...
export function InvoiceDetail({
  ...
  // Mock line items based on amount
  const items = [
  {
    description: 'Labor - Plumbing Repair',
    qty: 1,
    rate: invoice.amount * 0.6
  },
  {
    description: 'Materials & Parts',
    qty: 1,
    rate: invoice.amount * 0.4
  }];
  ...
  return (
    <div className="flex flex-col h-full bg-background">
        ...
        <div className="bg-white dark:bg-surface rounded-3xl p-6 shadow-card border border-border relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-6 mb-8">
            <div>
              ...
              <p className="text-xs text-text-secondary">Accra, Ghana</p>
            </div>
      ...
      <div className="p-4 bg-surface border-t border-border flex-shrink-0 flex gap-3">
        ...
        <ActionButton className="flex-1" variant="gradient">
            Convert to Invoice
          </ActionButton> :
