...
'lucide-react';
export type TabType = 'home' | 'jobs' | 'skill-hub' | 'messages' | 'profile';
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              <div
                className={`absolute top-0 w-8 h-1 rounded-full transition-all duration-300 ${isActive ? 'bg-primary scale-100' : 'bg-transparent scale-0'}`} />
